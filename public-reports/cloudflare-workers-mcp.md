# MCP Trust Report: github:cloudflare/workers-mcp
...
Enables arbitrary shell command execution with the process privileges. (Severity reduced high→medium: this match is in build/dev-tooling code — src/scripts/utils.ts — which does not run as part of the MCP server.)

**Evidence:** `src/scripts/utils.ts:4`
...
**Evidence:** `src/scripts/utils.ts:32`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→medium: this match is in build/dev-tooling code — src/scripts/generate-docs.ts — which does not run as part of the MCP server.)

**Evidence:** `src/scripts/generate-docs.ts:228`
...
**Evidence:** `src/scripts/install-claude.ts:39`
...
**Evidence:** `src/scripts/local-proxy.ts:193`
...
**Evidence:** `src/scripts/local-proxy.ts:195`
...
**Evidence:** `src/scripts/local-proxy.ts:200`
...
**Evidence:** `src/scripts/local-proxy.ts:202`
...
**Evidence:** `src/scripts/secret.ts:33`
...
**Evidence:** `src/scripts/setup.ts:197`
...
**Evidence:** `src/scripts/local-proxy.ts:163`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:37:54.294Z._
