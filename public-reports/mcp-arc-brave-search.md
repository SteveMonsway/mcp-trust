# MCP Trust Report: github:modelcontextprotocol/servers-archived/src/brave-search
...
**Evidence:** `index.ts:82`

```
const BRAVE_API_KEY = <redacted:secret>
```
...
_Generated by mcp-trust 0.5.2 at 2026-07-08T12:47:25.908Z._
