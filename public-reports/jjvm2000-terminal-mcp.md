# MCP Trust Report: github:jjvm2000/terminal-mcp
...
- Elevated to NEEDS_REVIEW by: MCP-TOOL-003
...
**Evidence:** `src/recording/recorder.ts:200`
...
**Evidence:** `src/recording/recorder.ts:219`
...
**Evidence:** `src/sandbox/controller.ts:78`
...
**Evidence:** `src/terminal/session.ts:369`
...
**Evidence:** `src/terminal/session.ts:376`
...
**Evidence:** `src/transport/socket.ts:104`
...
**Evidence:** `src/transport/socket.ts:129`
...
**Evidence:** `src/terminal/session.ts:119`
...
#### MCP-TOOL-003: Shell/command execution capability
**Severity:** high  **Confidence:** 60%  **Category:** capability

The server can execute shell commands on the host.
...
**Impact:** The server can execute shell commands on the host.
...
**Evidence:** `src/recording/recorder.ts:87`
...
**Evidence:** `src/recording/recorder.ts:215`
...
**Evidence:** `src/terminal/session.ts:98`
...
- Run in an isolated container with no network and a read-only workspace.

## Disclaimer
> MCP Trust provides evidence-based risk assessment. It does not guarantee that a server is safe or malicious. Use results as input to security review, sandboxing and policy decisions.

_Generated by mcp-trust 0.5.3 at 2026-07-08T14:48:07.385Z._
