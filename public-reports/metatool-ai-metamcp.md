# MCP Trust Report: github:metatool-ai/metamcp
...
**Evidence:** `apps/backend/src/auth.ts:18`

```
const BETTER_AUTH_SECRET = <redacted:secret>
```
...
**Evidence:** `apps/backend/src/auth.ts:42`
...
**Evidence:** `apps/backend/src/db/repositories/api-keys.repo.ts`
...
**Evidence:** `apps/backend/src/lib/metamcp/client.ts:110`
...
**Evidence:** `apps/backend/src/middleware/api-key-oauth.middleware.ts:80`
...
**Evidence:** `apps/backend/src/routers/mcp-proxy/server.ts:324`
...
**Evidence:** `apps/frontend/hooks/useConnection.ts:279`
...
**Evidence:** `apps/frontend/hooks/useConnection.ts:414`
...
**Evidence:** `apps/frontend/hooks/useConnection.ts:442`
...
**Evidence:** `apps/frontend/hooks/useConnection.ts:471`
...
**Evidence:** `apps/frontend/hooks/useConnection.ts:501`
...
**Evidence:** `apps/frontend/lib/trpc.ts:19`
...
**Evidence:** `apps/frontend/lib/trpc.ts:34`
...
**Evidence:** `apps/backend/src/auth.ts:11`
...
**Evidence:** `apps/backend/src/auth.ts:38`
...
**Evidence:** `apps/backend/src/lib/bootstrap.service.ts:156`

```
const singleUserPassword = <redacted:secret>
```
...
**Evidence:** `apps/backend/src/lib/bootstrap.service.ts:183`
...
**Evidence:** `apps/backend/src/lib/bootstrap.service.ts:187`
...
**Evidence:** `apps/backend/src/lib/bootstrap.service.ts:206`

```
apiKeys: <redacted:secret>, []),
```
...
**Evidence:** `apps/backend/src/lib/config.service.ts:168`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:26:59.565Z._
