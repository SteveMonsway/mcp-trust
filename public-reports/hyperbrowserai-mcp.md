# MCP Trust Report: github:hyperbrowserai/mcp
...
**Evidence:** `scripts/generate_statics.ts:34`
...
**Evidence:** `scripts/generate_statics.ts:50`
...
**Evidence:** `scripts/summarize_statics.ts:70`
...
**Evidence:** `src/transports/sse.ts:52`
...
**Evidence:** `src/transports/sse.ts:84`
...
**Evidence:** `scripts/generate_statics.ts:4`

```
const API_KEY: <redacted:secret> = process.env.HYPERBROWSER_API_KEY ?? "";
```
...
**Evidence:** `scripts/summarize_statics.ts:17`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:36:32.508Z._
