# MCP Trust Report: github:ConechoAI/Nano-Banana-MCP
...
**Evidence:** `test-integration.ts:94`
...
**Evidence:** `test-integration.ts:151`
...
**Evidence:** `test-integration.ts:62`
...
**Evidence:** `test-integration.ts:137`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→low: this match is in test code — src/test/index.test.ts — which does not run as part of the MCP server.)

**Evidence:** `src/test/index.test.ts:56`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced medium→low: this match is in test code — src/test/index.test.ts — which does not run as part of the MCP server.)

**Evidence:** `src/test/index.test.ts:46`
...
**Evidence:** `src/index.ts:606`

```
const envApiKey = <redacted:secret>
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:45:56.086Z._
