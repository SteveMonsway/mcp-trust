# MCP Trust Report: github:aliargun/mcp-server-gemini
...
**Evidence:** `src/enhanced-stdio-server.ts`
...
**Evidence:** `src/enhanced-stdio-server.ts:1236`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:46.759Z._
