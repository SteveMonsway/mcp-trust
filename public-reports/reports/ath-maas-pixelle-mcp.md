# MCP Trust Report: github:ATH-MaaS/Pixelle-MCP
...
**Evidence:** `pixelle/utils/process_util.py:82`
...
**Evidence:** `pixelle/utils/process_util.py:86`
...
**Evidence:** `pixelle/manager/workflow_manager.py:208`
...
**Evidence:** `pixelle/comfyui/base_executor.py:264`
...
**Evidence:** `pixelle/manager/workflow_manager.py:257`
...
**Evidence:** `pixelle/utils/file_util.py:211`
...
**Evidence:** `pixelle/utils/runninghub_util.py:149`
...
**Evidence:** `pixelle/cli/setup/config_saver.py:33`
...
**Evidence:** `pixelle/cli/utils/server_utils.py:125`
...
**Evidence:** `pixelle/cli/utils/server_utils.py:135`
...
**Evidence:** `pixelle/upload/local_storage.py:41`
...
**Evidence:** `pixelle/utils/file_uploader.py:41`
...
**Evidence:** `pixelle/utils/os_util.py:64`
...
**Evidence:** `pixelle/utils/user_settings_util.py:43`
...
**Evidence:** `pixelle/utils/workflow_source_util.py:148`
...
**Evidence:** `pixelle/web/chat/starters.py:269`
...
**Evidence:** `pixelle/utils/dynamic_util.py:23`
...
**Evidence:** `pixelle/utils/user_settings_util.py`
...
**Evidence:** `pixelle/web/chat/chat_settings.py`
...
```
Enter system prompt, which will guide the behavior and response of the AI assistant.
```
...
```
Restored system prompt to default value
```
...
```
update system prompt: {system_prompt}
```
...
**Evidence:** `pixelle/utils/file_uploader.py:84`
...
**Evidence:** `pixelle/utils/network_util.py:12`
...
**Evidence:** `pixelle/utils/network_util.py:30`
...
**Evidence:** `pixelle/utils/network_util.py:44`
...
**Evidence:** `pixelle/utils/network_util.py:57`
...
**Evidence:** `pixelle/utils/network_util.py:70`
...
**Evidence:** `pixelle/utils/network_util.py:91`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:30:40.356Z._
