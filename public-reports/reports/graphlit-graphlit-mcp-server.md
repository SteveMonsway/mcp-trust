# MCP Trust Report: github:graphlit/graphlit-mcp-server
...
**Evidence:** `src/tools.ts:2377`

```
const refreshToken = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:2802`

```
const appSecret = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:3268`

```
const botToken = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:3938`

```
const personalAccessToken = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:4951`

```
const consumerSecret = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:4959`

```
const accessTokenKey = <redacted:secret>
```
...
**Evidence:** `src/tools.ts:4967`

```
const accessTokenSecret = <redacted:secret>
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:27.010Z._
