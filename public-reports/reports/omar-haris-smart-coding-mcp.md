# MCP Trust Report: github:omar-haris/smart-coding-mcp
...
**Evidence:** `lib/sqlite-cache.js:394`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→medium: this match is in build/dev-tooling code — scripts/clear-cache.js — which does not run as part of the MCP server.)

**Evidence:** `scripts/clear-cache.js:22`
...
**Evidence:** `features/index-codebase.js:305`
...
**Evidence:** `features/index-codebase.js:488`
...
**Evidence:** `features/index-codebase.js:638`
...
**Evidence:** `features/check-last-version.js:171`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→low: this match is in test code — test/better-sqlite3.test.js — which does not run as part of the MCP server.)

**Evidence:** `test/better-sqlite3.test.js:42`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→low: this match is in test code — test/helpers.js — which does not run as part of the MCP server.)

**Evidence:** `test/helpers.js:81`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:58.157Z._
