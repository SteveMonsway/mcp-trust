# MCP Trust Report: github:googleads/google-ads-mcp
...
**Evidence:** `ads_mcp/update_references.py:52`
...
**Evidence:** `ads_mcp/coordinator.py:60`
...
**Evidence:** `ads_mcp/resources/discovery.py:46`
...
**Evidence:** `ads_mcp/resources/metrics.py:45`
...
**Evidence:** `ads_mcp/resources/release_notes.py:45`
...
**Evidence:** `ads_mcp/resources/segments.py:45`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced medium→low: this match is in test code — tests/smoke/generate_golden.py — which does not run as part of the MCP server.)

**Evidence:** `tests/smoke/generate_golden.py:41`
...
**Evidence:** `tests/smoke/generate_golden.py:60`
...
**Evidence:** `tests/smoke/generate_golden.py:150`
...
**Evidence:** `ads_mcp/coordinator.py:27`

```
_CLIENT_SECRET = <redacted:secret>"GOOGLE_ADS_MCP_OAUTH_CLIENT_SECRET")
```
...
**Evidence:** `ads_mcp/utils.py:84`

```
dev_token = <redacted:secret>"GOOGLE_ADS_DEVELOPER_TOKEN")
```
...
**Evidence:** `tests/smoke/generate_golden.py:67`
...
**Evidence:** `tests/smoke/llm_sender.py:45`

```
api_key = <redacted:secret>"GEMINI_API_KEY")
```
...
**Evidence:** `tests/smoke/llm_test.py:32`
...
**Evidence:** `tests/smoke/test_token_usage.py:55`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:37:09.097Z._
