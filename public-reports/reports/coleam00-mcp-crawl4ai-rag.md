# MCP Trust Report: github:coleam00/mcp-crawl4ai-rag
...
**Evidence:** `knowledge_graphs/parse_repo_into_neo4j.py:499`
...
**Evidence:** `knowledge_graphs/parse_repo_into_neo4j.py:606`
...
**Evidence:** `knowledge_graphs/hallucination_reporter.py:367`
...
**Evidence:** `knowledge_graphs/hallucination_reporter.py:376`
...
**Evidence:** `src/crawl4ai_mcp.py:298`
...
**Evidence:** `knowledge_graphs/ai_hallucination_detector.py:293`

```
neo4j_password = <redacted:secret> or os.environ.get('NEO4J_PASSWORD', 'password')
```
...
**Evidence:** `knowledge_graphs/parse_repo_into_neo4j.py:820`

```
neo4j_password = <redacted:secret>'NEO4J_PASSWORD', 'password')
```
...
**Evidence:** `knowledge_graphs/query_knowledge_graph.py:366`
...
**Evidence:** `knowledge_graphs/test_script.py:102`
...
**Evidence:** `knowledge_graphs/test_script.py:29`

```
api_key = <redacted:secret>'OPENAI_API_KEY', 'no-api-key-provided')
```
...
**Evidence:** `src/crawl4ai_mcp.py:64`
...
**Evidence:** `src/crawl4ai_mcp.py:168`

```
neo4j_password = <redacted:secret>"NEO4J_PASSWORD")
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:15.948Z._
