# MCP Trust Report: github:abhiz123/todoist-mcp-server
...
**Evidence:** `src/index.ts:145`

```
const TODOIST_API_TOKEN = <redacted:secret>
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:42:55.890Z._
