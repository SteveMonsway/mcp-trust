# MCP Trust Report: github:esxr/langgraph-mcp
...
**Evidence:** `src/langgraph_mcp/configuration.py`

```
The system prompt used for processing and refining routing queries.
```
...
```
The system prompt used for generating routing response.
```
...
```
The system prompt used for summarizing conversation.
```
...
```
The system prompt used for MCP server orchestration.
```
...
```
The system prompt used for tool refining orchestration.
```
...
**Evidence:** `src/langgraph_mcp/utils/openapi_spec.py:261`
...
**Evidence:** `src/langgraph_mcp/utils/openapi_utils.py:195`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:02.137Z._
