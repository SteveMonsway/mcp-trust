# MCP Trust Report: github:tuannvm/codex-mcp-server
...
**Evidence:** `src/utils/command.ts:61`
...
**Evidence:** `src/utils/command.ts:169`
...
Enables arbitrary shell command execution with the process privileges. (Severity reduced high→low: this match is in test code — src/__tests__/mcp-stdio.test.ts — which does not run as part of the MCP server.)

**Evidence:** `src/__tests__/mcp-stdio.test.ts:67`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:39:07.376Z._
