# MCP Trust Report: github:CopilotKit/open-mcp-client
...
**Evidence:** `app/api/copilotkit/route.ts:20`

```
apiKey: <redacted:secret>"OPENAI_API_KEY"],
```
...
**Evidence:** `app/api/copilotkit/route.ts:27`

```
langsmithApiKey: <redacted:secret>,
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:28:59.811Z._
