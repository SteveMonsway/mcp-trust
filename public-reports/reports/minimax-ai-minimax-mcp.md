# MCP Trust Report: github:MiniMax-AI/MiniMax-MCP
...
**Evidence:** `minimax_mcp/server.py:219`
...
**Evidence:** `minimax_mcp/__main__.py:99`
...
**Evidence:** `minimax_mcp/server.py:132`
...
**Evidence:** `minimax_mcp/server.py:254`
...
**Evidence:** `minimax_mcp/server.py:415`
...
**Evidence:** `minimax_mcp/server.py:485`
...
**Evidence:** `minimax_mcp/server.py:555`
...
**Evidence:** `minimax_mcp/server.py:648`
...
**Evidence:** `minimax_mcp/server.py:726`
...
**Evidence:** `minimax_mcp/server.py:210`
...
**Evidence:** `minimax_mcp/server.py:255`
...
**Evidence:** `minimax_mcp/server.py:286`
...
**Evidence:** `minimax_mcp/server.py:412`
...
**Evidence:** `minimax_mcp/server.py:482`
...
**Evidence:** `minimax_mcp/server.py:552`
...
**Evidence:** `tests/test_utils.py:100`
...
**Evidence:** `minimax_mcp/__main__.py:38`

```
final_api_key = <redacted:secret> or os.environ.get("MINIMAX_API_KEY")
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:38.459Z._
