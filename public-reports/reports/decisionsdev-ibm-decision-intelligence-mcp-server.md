# MCP Trust Report: github:DecisionsDev/ibm-decision-intelligence-mcp-server
...
**Evidence:** `src/diruntimeclient.ts:43`
...
**Evidence:** `src/diruntimeclient.ts:61`
...
**Evidence:** `src/diruntimeclient.ts:70`
...
**Evidence:** `src/diruntimeclient.ts:79`
...
**Evidence:** `src/diruntimeclient.ts:132`
...
**Evidence:** `src/diruntimeclient.ts:154`
...
Metadata contains zero-width/bidi control characters or long encoded payloads that can hide instructions. (Severity reduced medium→low: this match is in test code — tests/diruntimeclient.test.ts — which does not run as part of the MCP server.)

**Evidence:** `tests/diruntimeclient.test.ts`

```
/deploymentSpaces/staging/decisions/decision123/openapi
```
...
**Evidence:** `tests/command-line.test.ts:364`

```
process.env.DI_APIKEY = <redacted:secret>
```
...
**Evidence:** `tests/command-line.test.ts:480`

```
process.env.ZEN_APIKEY = <redacted:secret>
```
...
**Evidence:** `tests/command-line.test.ts:623`

```
process.env.BASIC_PASSWORD = <redacted:secret>
```
...
**Evidence:** `tests/credential.test.ts:256`
...
**Evidence:** `tests/credential.test.ts:267`
...
**Evidence:** `tests/credential.test.ts:290`
...
**Evidence:** `tests/credential.test.ts:460`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:16.841Z._
