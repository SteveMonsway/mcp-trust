# MCP Trust Report: github:jasonjmcghee/WebMCP
...
**Evidence:** `src/websocket-server.js:1262`
...
**Evidence:** `src/websocket-server.js:1231`
...
**Evidence:** `src/websocket-server.js:1490`
...
**Evidence:** `src/websocket-server.js:1243`
...
**Evidence:** `src/config.js:31`

```
const SERVER_TOKEN = <redacted:secret> || '';
```
...
**Evidence:** `src/websocket-server.js:113`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:50:36.306Z._
