# MCP Trust Report: github:intuit/quickbooks-online-mcp-server
...
**Evidence:** `src/clients/quickbooks-client.ts:256`
...
**Evidence:** `src/clients/quickbooks-client.ts:253`
...
**Evidence:** `src/handlers/create-quickbooks-attachable.handler.ts:125`
...
**Evidence:** `src/clients/quickbooks-client.ts:33`
...
**Evidence:** `src/clients/quickbooks-client.ts:34`
...
**Evidence:** `tests/unit/clients/quickbooks-client.auth.test.ts:22`

```
process.env.QUICKBOOKS_CLIENT_SECRET = '<redacted:secret>';
```
...
**Evidence:** `tests/unit/clients/quickbooks-client.auth.test.ts:23`

```
process.env.QUICKBOOKS_REFRESH_TOKEN = '<redacted:secret>';
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:40.084Z._
