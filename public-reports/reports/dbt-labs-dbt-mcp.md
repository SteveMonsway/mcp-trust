# MCP Trust Report: github:dbt-labs/dbt-mcp
...
_Resolved ref: `df5ff3d5c83151c16c1f9efb55d464fe38b50f6f`_
...
**Evidence:** `src/dbt_mcp/contract/snapshot.py:473`
...
**Evidence:** `tests/conftest.py:134`
...
**Evidence:** `examples/ai_sdk_agent/src/index.ts:14`
...
**Evidence:** `examples/ag2_agent/main_multiagent.py:68`

```
token = <redacted:secret>"DBT_TOKEN"]
```
...
**Evidence:** `examples/ag2_agent/main_multiagent.py:80`
...
**Evidence:** `examples/ag2_agent/main_remote.py:25`
...
**Evidence:** `examples/ag2_agent/main_remote.py:37`
...
**Evidence:** `examples/ag2_agent/main_stdio.py:34`
...
**Evidence:** `examples/aws_strands_agent/dbt_data_scientist/quick_mcp_test.py:19`
...
**Evidence:** `examples/aws_strands_agent/dbt_data_scientist/tools/dbt_mcp.py:16`

```
DBT_TOKEN = <redacted:secret>"DBT_TOKEN")
```
...
**Evidence:** `examples/google_adk_agent/main.py:17`
...
**Evidence:** `examples/langgraph_agent/main.py:37`
...
**Evidence:** `examples/openai_agent/main_streamable.py:48`
...
**Evidence:** `examples/openai_responses/main.py:11`
...
**Evidence:** `examples/pydantic_ai_agent/main.py:14`
...
**Evidence:** `src/remote_mcp/session.py:23`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:38:52.749Z._
