# MCP Trust Report: github:andrea9293/mcp-documentation-server
...
**Evidence:** `src/web-server.ts:265`
...
**Evidence:** `src/web-server.ts:281`
...
**Evidence:** `src/gemini-search-service.ts:30`

```
const geminiApiKey = <redacted:secret> || apiKey;
```
...
**Evidence:** `src/web-server.ts:239`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:30.901Z._
