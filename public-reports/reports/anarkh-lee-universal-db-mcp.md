# MCP Trust Report: github:Anarkh-Lee/universal-db-mcp
...
**Evidence:** `src/utils/config-loader.ts:55`

```
apiKeys: <redacted:secret> ? process.env.API_KEYS.split(',').map(k => k.trim()) : [],
```
...
**Evidence:** `src/utils/config-loader.ts:50`
...
**Evidence:** `src/utils/config-loader.ts:58`
...
**Evidence:** `src/utils/config-loader.ts:82`
...
**Evidence:** `tests/unit/config-loader.test.ts:29`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:50:13.843Z._
