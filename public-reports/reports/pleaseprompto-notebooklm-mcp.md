# MCP Trust Report: github:PleasePrompto/notebooklm-mcp
...
**Evidence:** `src/auth/auth-manager.ts:1014`
...
**Evidence:** `src/auth/auth-manager.ts:1099`
...
**Evidence:** `src/auth/auth-manager.ts:1028`
...
**Evidence:** `src/auth/auth-manager.ts:1049`
...
**Evidence:** `src/auth/auth-manager.ts:1055`
...
**Evidence:** `src/auth/auth-manager.ts:1079`
...
**Evidence:** `src/auth/auth-manager.ts:1088`
...
**Evidence:** `src/utils/cleanup-manager.ts:675`
...
**Evidence:** `src/auth/auth-manager.ts:85`
...
**Evidence:** `src/library/notebook-library.ts:106`
...
**Evidence:** `src/utils/settings-manager.ts:93`
...
**Evidence:** `src/config.ts:205`

```
loginPassword: <redacted:secret> || config.loginPassword,
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:26:29.603Z._
