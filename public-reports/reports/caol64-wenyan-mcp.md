# MCP Trust Report: github:caol64/wenyan-mcp
...
Reads files using a dynamically constructed path, allowing reads outside the intended scope. (Severity reduced medium→low: this match is in test code — tests/publish.js — which does not run as part of the MCP server.)

**Evidence:** `tests/publish.js:84`
...
**Evidence:** `tests/list.js:5`

```
const LLM_API_KEY = <redacted:secret>
```
...
**Evidence:** `tests/registerTheme.js:5`
...
**Evidence:** `tests/removeTheme.js:5`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:30:10.606Z._
