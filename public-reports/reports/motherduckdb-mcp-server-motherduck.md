# MCP Trust Report: github:motherduckdb/mcp-server-motherduck
...
**Evidence:** `src/mcp_server_motherduck/database.py:143`
...
**Evidence:** `src/mcp_server_motherduck/database.py:144`
...
**Evidence:** `src/mcp_server_motherduck/database.py:145`
...
**Evidence:** `tests/e2e/conftest.py:20`
...
**Evidence:** `tests/e2e/conftest.py:21`
...
**Evidence:** `tests/e2e/conftest.py:22`
...
**Evidence:** `tests/e2e/conftest.py:23`
...
**Evidence:** `tests/e2e/conftest.py:94`

```
token = <redacted:secret>"MOTHERDUCK_TOKEN")
```
...
**Evidence:** `tests/e2e/conftest.py:103`

```
token = <redacted:secret>"MOTHERDUCK_TOKEN_READ_SCALING")
```
...
**Evidence:** `tests/e2e/fixtures/create_test_db.py:32`

```
token = <redacted:secret>"MOTHERDUCK_TOKEN_READ_SCALING") or os.environ.get("MOTHERDUCK_TOKEN")
```
...
**Evidence:** `src/mcp_server_motherduck/database.py:293`
...
**Evidence:** `src/mcp_server_motherduck/database.py:294`

```
token = <redacted:secret>"motherduck_token") or os.getenv("MOTHERDUCK_TOKEN")
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:09.896Z._
