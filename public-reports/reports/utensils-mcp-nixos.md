# MCP Trust Report: github:utensils/mcp-nixos
...
**Evidence:** `mcp_nixos/caches.py:46`
...
**Evidence:** `mcp_nixos/caches.py:130`
...
**Evidence:** `mcp_nixos/caches.py:170`
...
**Evidence:** `mcp_nixos/caches.py:212`
...
**Evidence:** `mcp_nixos/sources/base.py:48`
...
**Evidence:** `mcp_nixos/sources/base.py:77`
...
**Evidence:** `mcp_nixos/sources/base.py:142`
...
**Evidence:** `mcp_nixos/sources/flakehub.py:15`
...
**Evidence:** `mcp_nixos/sources/flakehub.py:64`
...
**Evidence:** `mcp_nixos/sources/flakehub.py:127`
...
**Evidence:** `mcp_nixos/sources/flakes.py:35`
...
**Evidence:** `mcp_nixos/sources/flakes.py:136`
...
**Evidence:** `mcp_nixos/sources/nixdev.py:133`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:52`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:56`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:93`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:184`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:249`
...
**Evidence:** `mcp_nixos/sources/nixhub.py:274`
...
**Evidence:** `mcp_nixos/sources/nixos.py:244`
...
**Evidence:** `mcp_nixos/sources/nixos.py:249`
...
**Evidence:** `mcp_nixos/sources/wiki.py:25`
...
**Evidence:** `mcp_nixos/sources/wiki.py:69`
...
**Evidence:** `mcp_nixos/utils.py:32`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→low: this match is in test code — tests/test_flake_inputs.py — which does not run as part of the MCP server.)

**Evidence:** `tests/test_flake_inputs.py:166`
...
**Evidence:** `tests/test_flake_inputs.py:173`
...
Reads files using a dynamically constructed path, allowing reads outside the intended scope. (Severity reduced medium→low: this match is in test code — tests/test_store.py — which does not run as part of the MCP server.)

**Evidence:** `tests/test_store.py:43`
...
**Evidence:** `tests/test_store.py:79`
...
**Evidence:** `tests/test_store.py:288`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced medium→low: this match is in test code — tests/test_flake_inputs.py — which does not run as part of the MCP server.)

**Evidence:** `tests/test_flake_inputs.py:248`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:50:29.152Z._
