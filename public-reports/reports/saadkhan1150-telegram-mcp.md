# MCP Trust Report: github:saadkhan1150/telegram-mcp
...
**Evidence:** `session_manager.py:113`
...
**Evidence:** `session_manager.py:115`
...
**Evidence:** `account_manager.py:48`
...
**Evidence:** `session_manager.py:40`
...
**Evidence:** `session_manager.py:54`
...
**Evidence:** `template_manager.py:37`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced medium→low: this match is in test code — test_web.py — which does not run as part of the MCP server.)

**Evidence:** `test_web.py:26`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:13.964Z._
