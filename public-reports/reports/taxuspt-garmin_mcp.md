# MCP Trust Report: github:Taxuspt/garmin_mcp
...
**Evidence:** `src/garmin_mcp/token_utils.py:127`
...
**Evidence:** `src/garmin_mcp/activity_analysis.py:147`
...
**Evidence:** `src/garmin_mcp/activity_analysis.py:132`
...
**Evidence:** `src/garmin_mcp/__init__.py:282`
...
**Evidence:** `src/garmin_mcp/activity_analysis.py:1302`
...
**Evidence:** `src/garmin_mcp/auth_cli.py:184`
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced medium→low: this match is in test code — tests/unit/test_auth_cli.py — which does not run as part of the MCP server.)

**Evidence:** `tests/unit/test_auth_cli.py:466`
...
**Evidence:** `src/garmin_mcp/__init__.py:75`

```
password = <redacted:secret>"GARMIN_PASSWORD")
```
...
**Evidence:** `src/garmin_mcp/__init__.py:76`

```
password_file = <redacted:secret>"GARMIN_PASSWORD_FILE")
```
...
**Evidence:** `src/garmin_mcp/auth_cli.py:60`
...
**Evidence:** `src/garmin_mcp/auth_cli.py:61`
...
**Evidence:** `tests/test_garmin.py:24`
...
**Evidence:** `tests/test_mcp_debug.py:21`
...
**Evidence:** `example.py:34`

```
password = <redacted:secret>"PASSWORD")
```
...
**Evidence:** `example.py:35`

```
tokenstore = <redacted:secret>"GARMINTOKENS") or "~/.garminconnect"
```
...
**Evidence:** `example.py:36`

```
tokenstore_base64 = <redacted:secret>"GARMINTOKENS_BASE64") or "~/.garminconnect_base64"
```
...
**Evidence:** `src/garmin_mcp/__init__.py:85`
...
**Evidence:** `src/garmin_mcp/__init__.py:86`
...
**Evidence:** `src/garmin_mcp/token_utils.py:16`
...
**Evidence:** `src/garmin_mcp/token_utils.py:25`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:50:26.667Z._
