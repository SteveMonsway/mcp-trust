# MCP Trust Report: github:vibheksoni/stealth-browser-mcp
...
**Evidence:** `src/process_cleanup.py:369`
...
**Evidence:** `src/dynamic_hook_system.py:84`
...
**Evidence:** `src/dynamic_hook_system.py:123`
...
**Evidence:** `src/debug_logger.py:441`
...
**Evidence:** `src/debug_logger.py:458`
...
**Evidence:** `src/debug_logger.py:472`
...
**Evidence:** `src/file_based_element_cloner.py:138`
...
**Evidence:** `src/process_cleanup.py:228`
...
**Evidence:** `src/response_handler.py:88`
...
**Evidence:** `src/element_cloner.py:343`
...
**Evidence:** `src/element_cloner.py:433`
...
**Evidence:** `src/element_cloner.py:449`
...
**Evidence:** `src/network_interceptor.py:298`
...
**Evidence:** `src/network_interceptor.py:300`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:52.486Z._
