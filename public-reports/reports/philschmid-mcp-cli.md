# MCP Trust Report: github:philschmid/mcp-cli
...
**Evidence:** `tests/config.test.ts:65`

```
process.env.TEST_MCP_TOKEN = '<redacted:secret>';
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:49.662Z._
