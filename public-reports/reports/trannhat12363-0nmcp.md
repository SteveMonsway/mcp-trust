# MCP Trust Report: github:TranNhat12363/0nMCP
...
**Evidence:** `command-runner.js:112`
...
**Evidence:** `command-runner.js:153`
...
**Evidence:** `orchestrator.js:49`

```
this.anthropic = new Anthropic({ apiKey: <redacted:secret> });
```
...
**Evidence:** `engine/operations.js:177`
...
**Evidence:** `engine/validator.js:203`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:43.370Z._
