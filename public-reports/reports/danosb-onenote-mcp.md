# MCP Trust Report: github:danosb/onenote-mcp
...
**Evidence:** `authenticate.js:36`

```
fs.writeFileSync(tokenFilePath, JSON.stringify({ token: <redacted:secret> }));
```
...
**Evidence:** `get-all-page-contents-full.js:72`
...
**Evidence:** `get-all-page-contents.js:91`
...
**Evidence:** `read-all-pages.js:146`
...
**Evidence:** `simple-page-content.js:71`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:03.292Z._
