# MCP Trust Report: github:VikashLoomba/copilot-mcp
...
**Evidence:** `src/panels/ExtensionPanel.ts:396`
...
**Evidence:** `src/panels/ExtensionPanel.ts:399`
...
**Evidence:** `src/panels/ExtensionPanel.ts:579`
...
Enables arbitrary shell command execution with the process privileges. (Severity reduced high→medium: this match is in build/dev-tooling code — scripts/bump-version-on-extension-change.mjs — which does not run as part of the MCP server.)

**Evidence:** `scripts/bump-version-on-extension-change.mjs:16`
...
**Evidence:** `scripts/bump-version-on-extension-change.mjs:23`
...
Enables arbitrary shell command execution with the process privileges. (Severity reduced high→medium: this match is in build/dev-tooling code — scripts/sync-opencode-copilot.mjs — which does not run as part of the MCP server.)

**Evidence:** `scripts/sync-opencode-copilot.mjs:64`
...
**Evidence:** `src/utilities/getNonce.ts`
...
**Evidence:** `src/providers/wellknown.ts:115`
...
**Evidence:** `src/providers/wellknown.ts:247`
...
**Evidence:** `src/providers/wellknown.ts:270`
...
**Evidence:** `src/skills-client.ts:72`
...
**Evidence:** `src/utilities/CopilotChat.ts:137`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:41:46.437Z._
