# MCP Trust Report: github:ref-tools/ref-tools-mcp
...
**Evidence:** `index.ts:238`

```
(currentApiKey && !process.env.REF_API_KEY ? currentApiKey : <redacted:secret>,
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:52.193Z._
