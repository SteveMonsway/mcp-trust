# MCP Trust Report: github:browserbase/mcp-server-browserbase
...
**Evidence:** `evals/run-evals.ts:238`
...
**Evidence:** `evals/run-evals.ts:239`
...
**Evidence:** `evals/run-evals.ts:180`
...
**Evidence:** `evals/run-evals.ts:267`
...
```
browserbaseApiKey: <redacted:secret> ?? "",
```
...
**Evidence:** `evals/run-evals.ts:135`
...
**Evidence:** `src/sessionManager.ts:27`
...
**Evidence:** `src/sessionManager.ts:28`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:01.272Z._
