# MCP Trust Report: github:sailorpepe/undesirables-mcp-server
...
Writes or deletes files, potentially outside a scoped workspace. (Severity reduced high→medium: this match is in build/dev-tooling code — scripts/vibes_dyli_healthcheck.py — which does not run as part of the MCP server.)

**Evidence:** `scripts/vibes_dyli_healthcheck.py:100`
...
**Evidence:** `scripts/kaggle_export.py:58`
...
**Evidence:** `scripts/kaggle_export.py:85`
...
**Evidence:** `scripts/kaggle_export.py:113`
...
**Evidence:** `scripts/kaggle_export.py:208`
...
**Evidence:** `scripts/vibes_dyli_healthcheck.py:32`
...
**Evidence:** `scripts/vibes_dyli_healthcheck.py:95`
...
```
s actual memories, personality, and backstory.
...
**Evidence:** `scripts/enrich_rarity.py:41`
...
**Evidence:** `scripts/import_to_sqlite.py:261`
...
**Evidence:** `scripts/sync_to_vercel_kv.py:55`
...
**Evidence:** `scripts/tcg_cron.py:59`
...
**Evidence:** `scripts/vibes_dyli_healthcheck.py:57`
...
**Evidence:** `scripts/vibes_dyli_healthcheck.py:85`
...
**Evidence:** `scripts/vibes_dyli_ingest.py:36`
...
**Evidence:** `scripts/vibes_dyli_sales_poller.py:74`
...
**Evidence:** `scripts/vibes_dyli_sales_poller.py:107`
...
**Evidence:** `ebay_oracle.py:25`

```
EBAY_CLIENT_SECRET = <redacted:secret>"EBAY_CLIENT_SECRET", "")
```
...
**Evidence:** `scripts/sync_to_vercel_kv.py:47`

```
KV_TOKEN = <redacted:secret>"KV_REST_API_TOKEN") or os.environ.get("UPSTASH_REDIS_REST_TOKEN")
```
...
**Evidence:** `scripts/vibes_ebay_tracker.py:64`
...
**Evidence:** `scripts/vibes_ebay_tracker.py:68`

```
ebay_oracle.EBAY_CLIENT_SECRET = <redacted:secret>"EBAY_CLIENT_SECRET"]
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:41.042Z._
