# MCP Trust Report: github:Stellify-Software-Ltd/stellify-mcp
...
```
Execute a method in sandboxed environment. Requires file and method UUIDs. Returns output, success, error, and optional benchmark data. CONSTRAINT: the sandbox blocks literal http://|https:// strings 
```
...
**Evidence:** `src/stellify-client.ts:85`
...
**Evidence:** `test-full-workflow.js:8`
...
**Evidence:** `test-html-conversion.js:8`
...
**Evidence:** `test-read-delete.js:8`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:44.713Z._
