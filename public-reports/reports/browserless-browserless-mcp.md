# MCP Trust Report: github:browserless/browserless-mcp
...
**Evidence:** `src/lib/account-resolver.ts:37`
...
**Evidence:** `src/lib/agent-client.ts:440`
...
**Evidence:** `src/lib/api-client.ts:146`
...
**Evidence:** `src/tools/crawl.ts:198`
...
**Evidence:** `src/config.ts:26`

```
browserlessToken: <redacted:secret>,
```
...
```
supabaseOAuthClientSecret: <redacted:secret> ?? '',
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:52:27.353Z._
