# MCP Trust Report: github:nunner322/mcp-arr
...
_Resolved ref: `75c7296be0aebde445b0804fb8fadcb597b28344`_
...
**Evidence:** `src/arr-client.ts:469`
...
**Evidence:** `src/trash-client.ts:205`
...
```
{ name: 'sonarr', displayName: 'Sonarr (TV)', url: process.env.SONARR_URL, apiKey: <redacted:secret> },
```
...
**Evidence:** `src/index.ts:43`

```
{ name: 'radarr', displayName: 'Radarr (Movies)', url: process.env.RADARR_URL, apiKey: <redacted:secret> },
```
...
**Evidence:** `src/index.ts:44`

```
{ name: 'lidarr', displayName: 'Lidarr (Music)', url: process.env.LIDARR_URL, apiKey: <redacted:secret> },
```
...
**Evidence:** `src/index.ts:45`

```
{ name: 'readarr', displayName: 'Readarr (Books)', url: process.env.READARR_URL, apiKey: <redacted:secret> },
```
...
**Evidence:** `src/index.ts:46`

```
{ name: 'prowlarr', displayName: 'Prowlarr (Indexers)', url: process.env.PROWLARR_URL, apiKey: <redacted:secret> },
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:48:02.457Z._
