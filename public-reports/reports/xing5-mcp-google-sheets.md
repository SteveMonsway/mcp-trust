# MCP Trust Report: github:xing5/mcp-google-sheets
...
**Evidence:** `src/mcp_google_sheets/server.py:122`
...
**Evidence:** `src/mcp_google_sheets/server.py:136`
...
**Evidence:** `src/mcp_google_sheets/server.py:33`
...
**Evidence:** `src/mcp_google_sheets/server.py:34`
...
**Evidence:** `src/mcp_google_sheets/server.py:35`
...
**Evidence:** `tests/test_google_integration.py:73`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:50:06.667Z._
