# MCP Trust Report: github:Jpisnice/shadcn-ui-mcp-server
...
Uses execSync (or spawnSync with shell:true), executing a command through a shell synchronously. (Severity reduced critical→medium: this match is in build/dev-tooling code — scripts/bump-version.js — which does not run as part of the MCP server.)

**Evidence:** `scripts/bump-version.js:54`
...
**Evidence:** `scripts/bump-version.js:55`
...
**Evidence:** `scripts/bump-version.js:56`
...
Uses eval() or the Function constructor to execute dynamically constructed code. (Severity reduced high→medium: this match is in build/dev-tooling code — src/tools/tweakcn/fetch-presets.ts — which does not run as part of the MCP server.)

**Evidence:** `src/tools/tweakcn/fetch-presets.ts:92`
...
**Evidence:** `src/tools/tweakcn/fetch-presets.ts:118`
...
**Evidence:** `scripts/bump-version.js:48`
...
**Evidence:** `src/cli/args.ts:19`

```
options.githubApiKey = <redacted:secret>
```
...
**Evidence:** `src/utils/axios-react-native.ts:20`
...
**Evidence:** `src/utils/axios-svelte.ts:19`
...
**Evidence:** `src/utils/axios-vue.ts:45`
...
**Evidence:** `src/utils/axios.ts:30`
...
**Evidence:** `src/server/index.ts:22`
...
**Evidence:** `src/tools/blocks/get-block.ts:26`
...
**Evidence:** `src/tools/blocks/list-blocks.ts:30`
...
**Evidence:** `src/tools/components/get-component-demo.ts:7`
...
**Evidence:** `src/tools/components/get-component-metadata.ts:7`
...
**Evidence:** `src/tools/components/get-component.ts:7`
...
**Evidence:** `src/tools/repository/get-directory-structure.ts:20`
...
**Evidence:** `src/tools/tweakcn/fetch-presets.ts:12`
...
**Evidence:** `src/utils/axios-react-native.ts:19`
...
**Evidence:** `src/utils/axios-svelte.ts:18`
...
**Evidence:** `src/utils/axios-vue.ts:44`
...
**Evidence:** `src/utils/axios.ts:29`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:49:06.058Z._
