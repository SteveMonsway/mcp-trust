# MCP Trust Report: github:cablate/mcp-google-map
...
**Evidence:** `src/cli.ts:465`

```
process.env.GOOGLE_MAPS_API_KEY = <redacted:secret> as string;
```
...
**Evidence:** `src/utils/apiKeyManager.ts:24`
...
**Evidence:** `src/services/NewPlacesService.ts:235`
...
**Evidence:** `src/services/toolclass.ts:267`
...
**Evidence:** `src/services/toolclass.ts:334`
...
**Evidence:** `src/services/toolclass.ts:434`
...
**Evidence:** `src/services/NewPlacesService.ts:82`

```
this.apiKey = <redacted:secret> || process.env.GOOGLE_MAPS_API_KEY || "";
```
...
**Evidence:** `src/services/RoutesService.ts:119`
...
**Evidence:** `src/services/toolclass.ts:60`
...
**Evidence:** `src/utils/apiKeyManager.ts:9`

```
this.defaultApiKey = <redacted:secret>
```
...
**Evidence:** `src/utils/requestContext.ts:16`
...
**Evidence:** `tests/smoke.test.ts:30`

```
const API_KEY = <redacted:secret>, i, a) => a[i - 1] === "--apikey") ?? process.env.GOOGLE_MAPS_API_KEY ?? "";
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:26.659Z._
