# MCP Trust Report: github:yuridivonis/whoop-mcp-server
...
**Evidence:** `src/whoop-client.ts:132`
...
**Evidence:** `src/crypto.ts:8`

```
const secret = <redacted:secret> || process.env.WHOOP_CLIENT_SECRET;
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:47:28.949Z._
