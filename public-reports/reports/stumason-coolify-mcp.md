# MCP Trust Report: github:StuMason/coolify-mcp
...
**Evidence:** `src/lib/coolify-client.ts:504`
...
**Evidence:** `src/lib/coolify-client.ts:585`
...
Metadata contains zero-width/bidi control characters or long encoded payloads that can hide instructions. (Severity reduced medium→low: this match is in test code — src/__tests__/coolify-client.test.ts — which does not run as part of the MCP server.)

**Evidence:** `src/__tests__/coolify-client.test.ts`
...
```
accessToken: <redacted:secret> || 'your-token-here',
```
...
**Evidence:** `src/__tests__/integration/diagnostics.integration.test.ts:21`

```
const COOLIFY_TOKEN = <redacted:secret>
```
...
**Evidence:** `src/__tests__/integration/smoke.integration.test.ts:21`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T15:51:18.164Z._
