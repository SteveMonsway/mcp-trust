# MCP Trust Report: github:6551Team/opennews-mcp
...
**Evidence:** `src/opennews_mcp/config.py:25`

```
API_TOKEN    = <redacted:secret>"OPENNEWS_TOKEN")    or _cfg.get("api_token", "")
```
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:28:28.109Z._
