# MCP Trust Report: github:XeroAPI/xero-mcp-server
...
**Evidence:** `src/clients/xero-client.ts:15`
...
**Evidence:** `src/clients/xero-client.ts:16`

```
const bearer_token = <redacted:secret>
```
...
**Evidence:** `examples/openai-agents/main.py:29`
...
_Generated by mcp-trust 0.5.3 at 2026-07-08T14:43:34.717Z._
